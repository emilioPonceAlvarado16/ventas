...
export default function SvgIcons(props) {
    ...
    switch (type) {
        ...
        case 'gear2':
            ...
            svg = (
                <div>
                    ...
                    <svg className="gear-svg small-gear" width={width} height={height} viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M19.4,12.6a1.5,1.5,0,0,0,0-1.2l2.1-1.6a.75.75,0,0,0,.18-.95l-2-3.4a.75.75,0,0,0-.91-.3l-2.5,1a3.58,3.58,0,0,0-.84-.49l-.38-2.7a.75.75,0,0,0-.74-.63H9.7a.75.75,0,0,0-.74.63l-.38,2.7a3.58,3.58,0,0,0-.84.49l-2.5-1a.75.75,0,0,0-.91.3l-2,3.4a.75.75,0,0,0,.18.95l2.1,1.6a1.5,1.5,0,0,0,0,1.2l-2.1,1.6a.75.75,0,0,0-.18.95l2,3.4a.75.75,0,0,0,.91.3l2.5-1c.26.18.53.35.84.49l.38,2.7a.75.75,0,0,0,.74.63h4.6a.75.75,0,0,0,.74-.63l.38-2.7c.31-.14.58-.31.84-.49l2.5,1a.75.75,0,0,0,.91-.3l2-3.4a.75.75,0,0,0-.18-.95ZM12,15.5A3.5,3.5,0,1,1,15.5,12,3.5,3.5,0,0,1,12,15.5Z" />
                    </svg>
                    <svg className="gear-svg large-gear" width="125" height="125" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M19.4,12.6a1.5,1.5,0,0,0,0-1.2l2.1-1.6a.75.75,0,0,0,.18-.95l-2-3.4a.75.75,0,0,0-.91-.3l-2.5,1a3.58,3.58,0,0,0-.84-.49l-.38-2.7a.75.75,0,0,0-.74-.63H9.7a.75.75,0,0,0-.74.63l-.38,2.7a3.58,3.58,0,0,0-.84.49l-2.5-1a.75.75,0,0,0-.91.3l-2,3.4a.75.75,0,0,0,.18.95l2.1,1.6a1.5,1.5,0,0,0,0,1.2l-2.1,1.6a.75.75,0,0,0-.18.95l2,3.4a.75.75,0,0,0,.91.3l2.5-1c.26.18.53.35.84.49l.38,2.7a.75.75,0,0,0,.74.63h4.6a.75.75,0,0,0,.74-.63l.38-2.7c.31-.14.58-.31.84-.49l2.5,1a.75.75,0,0,0,.91-.3l2-3.4a.75.75,0,0,0-.18-.95ZM12,15.5A3.5,3.5,0,1,1,15.5,12,3.5,3.5,0,0,1,12,15.5Z" />
                    </svg>
                    <style jsx>{`
                        .gear-svg {
        ...
        case 'international':
            svg =
                (
                    <div className="f-icon-regular w-embed"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 16 16" fill="none">
        ...
        case 'edit':
            svg = (
                <div className="f-icon w-embed" title="Editar">
        ...
        case 'delete':
            svg = (
                <div className="f-icon w-embed" title="Eliminar">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M3 6H5H21" stroke="red" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M19 6V20C19 20.5304 18.7893 21.0391 18.4142 21.4142C18.0391 21.7893 17.5304 22 17 22H7C6.46957 22 5.96086 21.7893 5.58579 21.4142C5.21071 21.0391 5 20.5304 5 20V6M8 6V4C8 3.46957 8.21071 2.96086 8.58579 2.58579C8.96086 2.21071 9.46957 2 10 2H14C14.5304 2 15.0391 2.21071 15.4142 2.58579C15.7893 2.96086 16 3.46957 16 4V6" stroke="red" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        ...
        case 'generateLink':
            svg = (
                <div title="Generar Link">
                    <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height="18px" width="18px" xmlns="http://www.w3.org/2000/svg">
