    ...
    <div className="f-container-regular">
      <div className="w-layout-grid f-footer-grid">
        <div id="w-node-a02ea398-1b74-9b6b-662f-1deaef0c3fea-d0d34bca">
          ...
          <div className="f-margin-bottom-141">
            <p className="f-paragraph-small-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit, curabitur maximus quam.</p>
          </div>
          <div className="f-footer-social-group">
            <a href="#" className="f-footer-social w-inline-block">
              <div className="f-icon-regular w-embed"><svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="f-footer-block">
          <div className="f-footer-title">Footer Title</div>
      ...
      <div className="f-footer-bottom">
        <div className="f-footer-copyright">
          <p className="f-footer-detail">Copyright ©2023 flowbase.co</p>
        </div>
      </div>
    </div>
  </div>
