...
export default function alerts(props) {
  ...
  return (
    ...
    <a href="#" className="f-alert-close w-inline-block">
      <div className="f-alert-x w-embed"><svg width="420" height="420"  fill="none" xmlns="http://www.w3.org/2000/svg">
